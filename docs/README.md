...
| [decisions/2026-07-22_m1_data_provider_and_universe.md](./decisions/2026-07-22_m1_data_provider_and_universe.md) | Accepted | M1：yfinance、股票池快照、provider-native / true-print 价格边界、fixture 生成器 |
...
| [decisions/2026-07-22_m3_watchlist_and_signal_lifecycle.md](./decisions/2026-07-22_m3_watchlist_and_signal_lifecycle.md) | Accepted | M3：setup_key 身份修正、relvol 口径、watchlist 过期、转移日志 |
