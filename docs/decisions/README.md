...
- [2026-07-24_index_change_volume_spike_verification.md](./2026-07-24_index_change_volume_spike_verification.md)（proposed；Issue #77）— 用版本化的 S&P 官方成分变更事实确定性验证生效前一交易日的极端成交量；缺失或冲突仍整轮 fail-closed
